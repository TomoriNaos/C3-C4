...
def generate_launch_description():
    ...
    output_dir_arg = DeclareLaunchArgument(
        'output_dir',
        default_value='/home/hu/usv_captures/annotation_raw',
        description='Directory for annotation images'
    )
    ...
    recorder = Node(
        ...
        name='annotation_image_recorder',
        output='screen',
        parameters=[{
            'use_sim_time': True,
    ...
    shutdown_when_done = RegisterEventHandler(
        OnProcessExit(
            ...
            on_exit=[EmitEvent(event=Shutdown(reason='annotation image capture finished'))],
        )
    )
